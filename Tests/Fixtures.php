...
class Fixtures
{
    ...
    {
        $customer_accnt_data = Payload\Customer::create(
            [
    ...
    {
        $card_payment_data = Payload\Transaction::create(
            [
                'amount' => 100.0,
                'type' => 'payment',
    ...
    {
        $bank_payment_data = Payload\Transaction::create(
            [
                'amount' => 100.0,
                'type' => 'payment',
                'payment_method' => new Payload\PaymentMethod(
