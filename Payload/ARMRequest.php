...
class ARMRequest
{
    ...
    function request($method, $args = [])
    {
        ...
        if ($result['object'] == 'error') {
            foreach (get_declared_classes() as $cls) {
                if (!is_subclass_of($cls, Exceptions\PayloadError::class)) {
                    continue;
                }
                if ($cls::getClassName() != $result['error_type']) {
                    continue;
                }
    ...
    public function delete($obj)
    {
        ...
        $obj = Utils::object2data($obj);
        return self::request('DELETE', ['json'=>$obj, 'mode'=>'query']);
    }
    ...
    public function update($obj)
    {
        ...
        return self::request('PUT', ['json'=>$obj, 'mode'=>'query']);
    }
